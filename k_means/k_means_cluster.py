...
max_exercised_stock_options, max_salary = 0,0
min_exercised_stock_options, min_salary = float("inf"), float("inf")
...
scaler=MinMaxScaler()
print 'Rescaled salary $200,000: ', scaler.fit_transform([[float(min_salary)],[200000],[float(max_salary)]])
print 'Rescaled exercised stock options $1000000: ', scaler.fit_transform([[float(min_exercised_stock_options)],[1000000],[float(max_exercised_stock_options)]])
